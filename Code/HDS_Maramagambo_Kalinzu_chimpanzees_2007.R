...
### Script:  HDS_Maramagambo_Kalinzu_chimpanzees_2007.R
...
## 6.8; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##
DMara_Kalinzu23 <- Mara_Kalinzu.V23  /(1.09*50* 6.7556)

##--------------------------------------------------##
# Total number of expected nests in the surveyed area
##---------------------------------------------------#
Mara_Kalinzu.lambda23 <- sum(lambda23[])

}
",fill=TRUE, file = "Kalinzu.mara.V23_2007_cov.txt")
...
Mara.Kal_2007.V23.cov <- jags(data_V23.cov, inits, params, "Kalinzu.mara.V23_2007_cov.txt", n.thin=nt,
                             n.chains=nc, n.burnin=nb, n.iter=ni,  parallel = T)

Mara.Kal_2007.V23.cov

### save output

save(Mara.Kal_2007.V23.cov, file = "Mara.Kal_2007.V23_chimps_hds.RData")


### Write output as a .csv

Mara.Kal_2007_V23_cov  <- Mara.Kal_2007.V23.cov$summary

write.csv(Mara.Kal_2007_V23_cov, "Mara.Kal.V23_2007_output_cov_q.csv")
