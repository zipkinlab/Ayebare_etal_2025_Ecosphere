...
### Script: CV_Maramagambo_elephants_2007_HDS.R
...
",fill=TRUE, file = "Eles_2007_hds_tr1.txt")
...
Eles_2007_hds.tr1 <- jags(data_V23.tr1, inits, params, "Eles_2007_hds_tr1.txt", n.thin=nt,
...
save(Eles_2007_hds.tr1, file = "Eles_2007_hds.tr1.RData")


### Write output as a .csv

Eles_2007_hds_tr1 <- Eles_2007_hds.tr1$summary

write.csv(Eles_2007_hds_tr1, "Eles_2007_hds_tr1_output_CV.csv")
