...
### Script: HDS_Kalinzu_chimpanzees_2021.R

### Chimpanzees
### Kalinzu Forest Reserve

## DescriptionCode : To format the data
...
##---------------------------------------------------------------------------------------------------------------##
DKalinzu23 <- Kalinzu.V23  /(1.09*49* 1.51815)
...
",fill=TRUE, file = "Kalinzu.V23_2021_cov.txt")
...
Kal_2021.V23.cov <- jags(data_V23.cov, inits, params, "Kalinzu.V23_2021_cov.txt", n.thin=nt,
...
save(Kal_2021.V23.cov, file = "Kal_2021.V23_cov_chimps_hds.RData")


### Write output as a .csv

Kal_2021_V23_cov  <- Kal_2021.V23.cov$summary

write.csv(Kal_2021_V23_cov, "Kal.V23_2021_output_cov_q.csv")