...
### Script: HDS_Maramagambo_chimpanzees_2007.R
...
## 5.2; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##
DMara23 <- Mara.V23  /(1.09*50* 5.253)
...
",fill=TRUE, file = "Mara.V23_2007_cov.txt")
...
Mara_2007.V23.cov <- jags(data_V23.cov, inits, params, "Mara.V23_2007_cov.txt", n.thin=nt,
...
save(Mara_2007.V23.cov, file = "Mara_2007.V23_chimps_hds.RData")


### Write output as a .csv
Mara_2007.V23_cov  <- Mara_2007.V23.cov$summary

write.csv(Mara_2007.V23_cov, "Mara.V23_2007_output_cov_q.csv")
