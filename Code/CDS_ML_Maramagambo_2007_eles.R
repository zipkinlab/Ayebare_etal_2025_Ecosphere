...
### Script:  CDS_ML_Maramagambo__2007_eles.R
...
Mara_R2 <- read.csv ("Elephant_mara_R2_2007.csv", header = T)
head(Mara_R2)
...
#-----------------------------------------------#
Mara_S2_O2 <- read.csv ("Elephant_mara_S2_O2_2007.csv", header = T)
head(Mara_S2_O2)
...
##---------------------------------------------------------------------------------------------------------------#######
mult2.R2.m <- list(creation = data.frame(rate=17*50, SE=0))
print(mult2.R2.m)
...
mult2.S2.O2.m <- list(creation = data.frame(rate=17 *50, SE=0))
print(mult2.S2.O2.m)
