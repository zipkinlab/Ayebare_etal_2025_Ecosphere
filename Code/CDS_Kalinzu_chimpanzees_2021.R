...
### Script: CDS_Kalinzu_chimpanzees_2021.R
...
## 1.52; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##

DKalinzu23 <- N23 /(1.09*49* 1.51815)


}
",fill=TRUE, file = "Kalinzu.V23_2021_cds.txt")
...
Kalinzu.V23_2021.cds <- jags(data_V23_cds, inits, params, "Kalinzu.V23_2021_cds.txt", n.thin=nt,
...
Kalinzu.V23_2021.cds


### save output
save(Kalinzu.V23_2021.cds, file = "Kal_2021.V23_chimps_cds.RData")


### Write output as a .csv

Kalinzu_2021_V23_cds  <- Kalinzu.V23_2021.cds$summary

write.csv(Kalinzu_2021_V23_cds, "Kalinzu.V23_2021_output_cds.csv")
