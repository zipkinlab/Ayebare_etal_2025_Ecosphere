...
### Script: CDS_Maramagambo_Kalinzu_chimpanzees_2007.R
...
DMara_Kalinzu23 <- N23 /(1.09*50* 6.7556)


}
",fill=TRUE, file = "Mara_Kalinzu.V23_2007_cds.txt")
...
Mara_Kalinzu.V23_2007.cds <- jags(data_V23_cds, inits, params, "Mara_Kalinzu.V23_2007_cds.txt", n.thin=nt,
...
Mara_Kalinzu.V23_2007.cds


### save output
save(Mara_Kalinzu.V23_2007.cds, file = "Mara.Kal_2007.V23_chimps_cds.RData")


### Write output as a .csv

Mara_Kalinzu.2007_V23_cds  <- Mara_Kalinzu.V23_2007.cds$summary

write.csv(Mara_Kalinzu.2007_V23_cds, "Mara_Kalinzu.V23_2007_output_cds.csv")
