...
### Script: CDS_ML_Maramagambo_Kalinzu_combined_2021.R
...
kalinzu_mara_R2 <- read.csv ("Kalinzu_Mara_combined_R2_2021.csv", header = T)
...
mult2 <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2)
...
#------------------------------#
kalinzu_mara_S2_O2 <- read.csv ("Kalinzu_Mara_combined_S2_O2_2021.csv", header = T)
...
mult2.S2.O2 <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2.S2.O2)
