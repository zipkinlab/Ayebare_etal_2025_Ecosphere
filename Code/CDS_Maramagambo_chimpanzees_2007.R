...
### Script:  CDS_Maramagambo_chimpanzees_2007.R
...
## 5.253; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##

DMara23 <- N23 /(1.09*50* 5.253)


}
",fill=TRUE, file = "Mara_V23_2007_cds.txt")
...
Mara.V23_2007.cds <- jags(data_V23_cds, inits, params, "Mara_V23_2007_cds.txt", n.thin=nt,
...
### save output
save(Mara.V23_2007.cds, file = "Mara_2007.V23_chimps_cds.RData")


### Write output as a .csv

Mara.2007_V23_cds  <- Mara.V23_2007.cds$summary

write.csv(Mara.2007_V23_cds, "Mara.V23_2007_output_cds.csv")
