...
### Script: CV_Maramagambo_Kalinzu_chimpanzees_2021_HDS.R
...
# Construct cell probabilities 
  ...
  pcap23_cv <- sum(f23_cv[])            # Average probability of detection 
   ...
   ##--------------------##
  ### Abundance model 2021 - cross validation
  ##--------------------##
...
",fill=TRUE, file = "Chimps_2021_hds_tr1.txt")
...
Chimps_2021_hds.tr1 <- jags(data_V23.tr1, inits, params, "Chimps_2021_hds_tr1.txt", n.thin=nt,
...
save(Chimps_2021_hds.tr1 , file = "Chimps_2021_hds_tr1.RData")


Chimps_2021_hds_tr1  <- Chimps_2021_hds.tr1$summary

write.csv(Chimps_2021_hds_tr1, "Chimps_2021_hds_tr1_ouput.csv")
