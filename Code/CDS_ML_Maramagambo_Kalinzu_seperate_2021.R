...
### Script:  CDS_ML_Maramagambo_Kalinzu_seperate_2021.R
...
Kal.Mara <- read.csv ("Kalinzu_Mara_R2_2021.csv", header = T)
head(Kal.Mara)
summary(Kal.Mara)
...
#-----------------------------------------------#
Mara_S2_O2 <- read.csv ("Mara_S2_O2_2021.csv", header = T)
head(Mara_S2_O2)

#-----------------------------------------------#
## import kalinzu data for O2 & S2 analysis
#-----------------------------------------------#
Kal_S2_O2 <- read.csv ("Kalinzu_S2_O2_2021.csv", header = T)
head(Kal_S2_O2)
...
mult2.R2.m <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2.R2.m)
...
mult2.S2.O2.m <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2.S2.O2.m)
...
### Abundance and density for nests
...
mult2.R2.k <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2.R2.k)
...
mult2.S2.O2.k <- list(creation = data.frame(rate=1.09 *49, SE=0))
print(mult2.S2.O2.k)
