...
### Script:  CDS_Maramagambo_elephants_2007.R
...
delta23 <- 1  #  max distance meters

# perpendicular distance meters
B23 <- 5  #  maximum perpendicular distance
...
DMara23 <- N23 /(17 *50* 1.0506)


}
",fill=TRUE, file = "Mara.V23_2007_cds.txt")
...
Mara.V23_2007.cds <- jags(data_V23_cds, inits, params, "Mara.V23_2007_cds.txt", n.thin=nt,
...
### save output
save(Mara.V23_2007.cds, file = "Eles_2007_mara_cds.RData")
...
write.csv(Mara.2007_V23_cds, "Mara_V23_2007_output_cds_eles.csv")
