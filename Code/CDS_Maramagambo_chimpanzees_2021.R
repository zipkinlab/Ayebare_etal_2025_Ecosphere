...
### Script:  CDS_Maramagambo_chimpanzees_2021.R
...
## 5.48315; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##

DMara23 <- N23 /(1.09*49* 5.48315)


}
",fill=TRUE, file = "Mara_V23_2021_cds.txt")
...
Mara.V23_2021.cds <- jags(data_V23_cds, inits, params, "Mara_V23_2021_cds.txt", n.thin=nt,
...
### save output
save(Mara.V23_2021.cds, file = "Mara_2021.V23_chimps_cds.RData")
...
write.csv(Mara.2021_V23_cds, "Mara.V23_2021_output_cds.csv")
