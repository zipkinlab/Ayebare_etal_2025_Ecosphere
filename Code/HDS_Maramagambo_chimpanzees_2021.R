...
### Script:  HDS_Maramagambo_chimpanzees_2021.R
...
#-------------------------------#
## Filter Maramagambo elevation values
#-------------------------------#
...
## 5.48; represents the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##
DMara23 <- Mara.V23  /(1.09*49* 5.4832)
...
",fill=TRUE, file = "Mara.V23_2021_cov.txt")
...
params <- c( "beta0", "beta1", "beta2", "N23", "lambda23", "lambda.star23", "Mara23",
             "DMara23", "Mara.lambda23","pcap23", "sigma23")
...
Mara_2021.V23.cov <- jags(data_V23.cov, inits, params, "Mara.V23_2021_cov.txt", n.thin=nt,
...
save(Mara_2021.V23.cov, file = "Mara_2021.V23_chimps_hds.RData")


### Write output as a .csv
Mara_2021.V23_cov  <- Mara_2021.V23.cov$summary

write.csv(Mara_2021.V23_cov, "Mara.V23_2021_output_cov_q.csv")
