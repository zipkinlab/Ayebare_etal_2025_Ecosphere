...
### Script: MHDS_Maramagambo_chimpanzees_2007_2021.R
...
### filter kalinzu observations 
V23.2021<- filter(V23.2021, Tr < 37)
head(V23.2021)
...
### filter kalinzu observations 
V123.2021 <- filter(V123.2021, Tr < 37)
...
###------------------------------------------------------------------------------------##
Mara.V1.2007  <- sum(N1.2007[])
Mara.V1.2021  <- sum(N1.2021[])
Mara.V23.2007 <- sum(N23.2007[])
Mara.V23.2021 <- sum(N23.2021[])
...
## 5.253 and 5.4832: represent the total area surveyed in sqkm
##---------------------------------------------------------------------------------------------------------------##

DMara23.2007  <- Mara.V23.2007 /(1.09*50* 5.253)
DMara23.2021  <- Mara.V23.2021 /(1.09*49* 5.4832)

##---------------------------------------------------------------------------------------------------------------##
#### posterior distribution of a change in population density between two survey periods (i.e., 2007 and 2021)
##---------------------------------------------------------------------------------------------------------------##
DMara_pop_change = DMara23.2021  - DMara23.2007 

##---------------------------##
## Nest decay rate
##---------------------------##
No.days.V1.2007 <- Mara.V1.2007   / (DMara23.2007 * 1.09*5.253)
No.days.V1.2021 <- Mara.V1.2021  / (DMara23.2021 * 1.09*5.4832)

##--------------------------------------------------##
# Total number of expected signs in the surveyed area
##---------------------------------------------------##

Mara.lambda.V1.07 <- sum(lambda1.2007[])
Mara.lambda.V23.07 <- sum(lambda23.2007[])
Mara.lambda.V1.21 <- sum(lambda1.2021[])
Mara.lambda.V23.21 <- sum(lambda23.2021[])

}
",fill=TRUE, file = "Mara.pop_spatial_temporal.txt")
...
params <- c( "beta0.V1.2007", "beta0.V23.2007", " beta0.V1.2021", " beta0.V23.2021","N1.2007", "No.days.V1.2007","No.days.V1.2021",
             "N23.2007", "N1.2021" ,"N23.2021", " lambda1.2007", " beta1.07", "beta2.07", " beta1.21", " beta2.21", "lambda23.2007",
              "lambda23.2007", "lambda23.2021", "Mara.lambda.V1.07","Mara.V1.2007", "Mara.lambda.V23.07","Mara.V23.2007", "Mara.lambda.V1.21",
             "Mara.V1.2021", "Mara.lambda.V23.21", "Mara.V23.2021", "DMara23.2007","DMara23.2021",
             "DMara_pop_change", "pcap23.2007","pcap23.2021", "sigma23.2007","sigma23.2021")
...
Mara_2007_2021_chimps <- jags(data_C2007n2021, inits, params, "Mara.pop_spatial_temporal.txt", n.thin=nt,
                          n.chains=nc, n.burnin=nb, n.iter=ni,  parallel = T)


Mara_2007_2021_chimps


save(Mara_2007_2021_chimps , file = "Mara_2007_2021_chimps_mhds.RData")


#### 

Mara_2007_2021.chimps <- Mara_2007_2021_chimps$summary

write.csv(Mara_2007_2021.chimps, "Mara_2007_2021_ouput_chimps_q.csv")
...
load(".../Mara_2007_2021_chimps_mhds.RData")
...
hist(Mara_2007_2021_chimps$sims.list$DMara_pop_change)

### Estimate the probability that the population has decreased
decrease <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change  < 0)/15000)
decrease

### Estimate the probability that the population has increased
increase <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change  > 0)/15000)
increase
...
five.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 5/100)
five.pct.decrease
### Probability that the population has decreased by 5 percent
prob.decrease.5pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < five.pct.decrease)/15000)
prob.decrease.5pct
...
####------------------------------##
ten.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 10/100)
ten.pct.decrease
### Probability that the population has decreased by 10 percent
prob.decrease.10pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < ten.pct.decrease)/15000)
prob.decrease.10pct
...
####------------------------------##
twenty.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 20/100)
twenty.pct.decrease
### Probability that the population has decreased by 20 percent
prob.decrease.20pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < twenty.pct.decrease)/15000)
prob.decrease.20pct
...
####------------------------------##
thirty.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 30/100)
thirty.pct.decrease
### Probability that the population has decreased by 30 percent
prob.decrease.30pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < thirty.pct.decrease)/15000)
prob.decrease.30pct

####------------------------------##
### 40 percent decrease in density
####------------------------------##
forty.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 40/100)
forty.pct.decrease
### Probability that the population has decreased by 40 percent
prob.decrease.40pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < forty.pct.decrease)/15000)
prob.decrease.40pct

####------------------------------##
### 50 percent decrease in density
####------------------------------##
fifty.pct.decrease <- -1 * (Mara_2007_2021_chimps$mean$DMara23.2007 * 50/100)
fifty.pct.decrease

### Probability that the population has decreased by 50 percent
prob.decrease.50pct <- (sum(Mara_2007_2021_chimps$sims.list$DMara_pop_change < fifty.pct.decrease)/15000)
prob.decrease.50pct
