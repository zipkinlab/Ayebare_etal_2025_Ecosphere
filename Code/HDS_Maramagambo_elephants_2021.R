...
### Script: HDS_Maramagambo_elephants_2021.R
...
",fill=TRUE, file = "Mara.V23_2021_cov_eles.txt")
...
Mara.V23_2021_eles.cov <- jags(data_V23.cov, inits, params, "Mara.V23_2021_cov_eles.txt", n.thin=nt,
                               n.chains=nc, n.burnin=nb, n.iter=ni,  parallel = T)


Mara.V23_2021_eles.cov


### save output
save(Mara.V23_2021_eles.cov, file = "Eles_2021_mara_hds.RData")


### Write output as a .csv

Mara.2021_V23_cov  <- Mara.V23_2021_eles.cov$summary

write.csv(Mara.2021_V23_cov, "Mara.V23_2021_output_eles_cov_q.csv")
